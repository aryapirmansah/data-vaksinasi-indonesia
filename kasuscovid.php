...
<tr>
 ...
 <th>Jumlah Meninggal</th>
    ...
    for($a = 0; $a < count($total); $a++){
        print "<tr>";
        print "<td>".$total[$a]['tanggal']."</td>";
        print "<td>".$total[$a]['jumlah_positif']."</td>";
        print "<td>".$total[$a]['jumlah_dirawat']."</td>";
        print "<td>".$total[$a]['jumlah_sembuh']."</td>";
        print "<td>".$total[$a]['jumlah_meninggal']."</td>";
        print "<tr/>";
